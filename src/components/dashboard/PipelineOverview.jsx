  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-xs p-6 flex flex-col h-full justify-between">
      <div>
        ...
        <p className="text-xs text-slate-400 dark:text-slate-500 dark:text-slate-400 dark:text-slate-500 mb-6">
        ...
        {totalLeads === 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-8 text-center">
            ...
            <p className="text-sm font-medium text-slate-400 dark:text-slate-500 dark:text-slate-400 dark:text-slate-500">No leads in pipeline</p>
          </div>
        ) : (
          <div>
              ...
              {segments.map((segment) => (
                ...
                >
                  ...
                  <div className="min-w-0">
                    <p className="text-xs font-semibold text-slate-400 dark:text-slate-500 dark:text-slate-400 dark:text-slate-500 uppercase tracking-wider truncate">
                      {segment.label}
                    </p>
                    <p className="text-lg font-bold text-slate-800 dark:text-slate-100 mt-0.5">
                      {segment.count}{' '}
                      <span className="text-xs font-normal text-slate-400 dark:text-slate-500 dark:text-slate-400 dark:text-slate-500">
      ...
      {/* Summary Footer */}
      {totalLeads > 0 && (
        <div className="border-t border-slate-50 dark:border-slate-800/50 pt-4 mt-6 flex justify-between items-center text-xs font-semibold text-slate-400 dark:text-slate-500 dark:text-slate-400 dark:text-slate-500">
