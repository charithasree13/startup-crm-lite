...
import { Rocket, User, Mail, Lock, UserPlus, ShieldAlert } from 'lucide-react';
import toast from 'react-hot-toast';

/**
 * Register Page Component
 * Connects signup form inputs to the AuthContext register action.
 */
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success('Admin registered successfully! Welcome.');
      navigate('/');
    } catch (err) {
